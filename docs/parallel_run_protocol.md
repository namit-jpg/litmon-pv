# Parallel-run protocol (Phase 1 pilot)
...
2. System: run search (Admin → Run PubMed search, or scheduler).  
3. Manual: continue usual screening and ICSR decisions.  
4. At cycle end:
   - Export **parallel-run package**: Admin → Export parallel-run comparison  
